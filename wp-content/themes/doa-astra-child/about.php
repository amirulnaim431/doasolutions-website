...
<main id="primary" class="doa-site doa-about-v2">
	...
	<nav class="doa-nav-v2 doa-nav-v2--inverse" aria-label="<?php esc_attr_e( 'Primary navigation', 'doa-solutions' ); ?>">
		<a class="doa-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>"><span class="doa-brand__mark" aria-hidden="true"><img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/doa-logo-icon-glow.png' ); ?>" alt=""></span><span>DOA <b>Solutions</b></span></a>
		...
		<div class="doa-nav-v2__links" id="doa-about-links">
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a><a href="#principles">Principles</a><a href="#capability-ledger">Capabilities</a><a class="doa-nav-v2__cta" href="<?php echo esc_url( home_url( '/#contact' ) ); ?>">Talk to us ↗</a>
		</div>
	</nav>
	...
	<section class="doa-about-v2__hero" id="about-content">
		...
		<div class="doa-about-v2__stamp" aria-hidden="true"><img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/doa-logo-icon-glow.png' ); ?>" alt=""><small>SYSTEMS / SOLUTIONS / SUPPORT</small></div>
	</section>
