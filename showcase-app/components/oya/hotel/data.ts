...
export type RoomStatus = 'Available' | 'Reserved' | 'Occupied' | 'Cleaning Required' | 'Cleaning In Progress' | 'Ready' | 'Maintenance' | 'Out of Service';
...
export const roomsSeed: HotelRoom[] = [
  ...
  { number: '108', type: 'Deluxe King', capacity: 2, baseRate: 228, status: 'Maintenance', cleaningStatus: 'Ready', facilities: ['King bed', 'Sofa', 'Mini fridge'], notes: 'Air-conditioner service ticket open.', active: true },
